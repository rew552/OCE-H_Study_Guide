...
- FIPS 140-2の要件を理解している
- Connection ServerでのFIPSモードデプロイメントを評価できる
- UAGでのFIPSモードデプロイメントを評価できる
- FIPSモードの影響（機能制限、パフォーマンス、互換性）を評価できる
...
### FIPS 140-2の概要
- [ ] FIPS 140-2の要件を理解している
- [ ] FIPS 140-2が適用される環境を説明できる

### Connection ServerでのFIPSモード
- [ ] Connection ServerでのFIPSモード有効化手順を説明できる
- [ ] FIPS準拠の証明書要件を理解している
- [ ] 承認された暗号化アルゴリズムを説明できる

### UAGでのFIPSモード
- [ ] UAGでのFIPSモード有効化手順を説明できる
- [ ] FIPSモードの影響を評価できる
