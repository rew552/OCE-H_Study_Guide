...
- App Volumes Managerのインストールと設定ができる
- 追加Managerの登録と高可用性構成ができる
- SQL接続とActive Directory設定ができる
- ストレージ設定とレプリケーション設定ができる

## 関連リソース

- [クイックリファレンス](../../00_Quick_Reference.md) - ポート番号、設定値、制限値
- [用語集](../../README.md#用語集) - 関連用語の定義
- [2.5 App Volumes](../../Section2_Desktop_Application_Profile_Management/2.5_App_Volumes.md) - App Volumes管理
